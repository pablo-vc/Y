...
@section('content')
    <div class="profile-header card" style="display:flex; flex-direction:column; gap:15px; padding:20px; border-radius:15px;">
    ...
    <div class="profile-posts" style="margin-top:20px;">
