...
Esta guía explica cómo instalar y ejecutar la aplicación en Windows.
...
- Sigue los pasos del instalador:
  - Selecciona la carpeta de instalación (la opción por defecto suele ser adecuada).
  - Haz clic en **Siguiente** o **Instalar** hasta finalizar el proceso.
...
- La carpeta de instalación (por defecto en `C:\Program Files\Y`).
...
## Consejos
- Para un acceso más rápido, puedes anclar la aplicación a la barra de tareas.
