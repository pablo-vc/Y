...
This folder contains the web client of **Y**, a cross-platform microblogging platform.

In this readme you will find all the information related to the web client, including a timeline and the relevant research areas that had impact on the development of the project.
