...
public class Api {
    ...
    // The file is divided by regions, each region calls an specified path
    // or derivatives
     ...
     * @return The user that just logged in or null if there is any error while logging in
     * */
    public static User login(String email, String password) {
        ...
        try {
            ...
            if (code == 200) {
                ...
                return new User(obj.getInt("id"), obj.getString("username"), obj.getString("email"), obj.getString("bio"), obj.getString("created_at"));
            } else {
    ...
    /**
     * This function makes a register request to the API SERVER
     * @param username New user password
     * @param email New user email
     * @param password New user password
     * @return Success if everything is ok, or, the error that occurred
     * */
    ...
    /**
     * Requests data from a specific user
     * @param userId Id from the user the data is requested
     * @return A User object that contains the info about the specified user returned by the API
     */
    ...
    /**
     * Requests all the available posts to the API
     * @return A list with all the posts the API returns
     */
    ...
    /**
     * Requests the last posts from users followed by the current user to the API
    ...
    /**
     * Requests the posts from an specific user to the API
     * @param userId Id of the user whose posts are requested
     * @return A list with all the posts the API returns
     */
